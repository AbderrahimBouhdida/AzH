...
// -ldflags "-X github.com/AbderrahimBouhdida/AzH/constants.Version=`git describe --tags --exact-match 2> /dev/null || git rev-parse HEAD`"
var Version string = "v0.0.0"

const (
	Name                 string = "AzH"
	DisplayName          string = "AzH"
	Description          string = ""
	AuthorRef            string = "Created by "
